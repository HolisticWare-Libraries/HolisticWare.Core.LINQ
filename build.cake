...
Task("unit-tests-xunit")
    .IsDependentOn("unit-tests-xunit-xunit2runner")
    .IsDependentOn("unit-tests-xunit-dotnetcoretest")
    ;

Task("unit-tests-xunit-xunit2runner")
    .Does
    (
        () =>
        {
...
Task("unit-tests-xunit-dotnetcoretest")
    .Does
    (
        () =>
        {
